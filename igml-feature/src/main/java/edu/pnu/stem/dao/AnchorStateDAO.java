...
public class AnchorStateDAO {
	public static AnchorState readAnchorState(IndoorGMLMap map, String id) {
		AnchorState target = null;
		try {
			target = (AnchorState) map.getFeature(id);
	...
	public static AnchorState createAnchorState(IndoorGMLMap map, String parentId, String id, String name, String description,
			Geometry geometry, String duality, List<String> connects, String unit_id, String address_id) {

		if (id == null) {
			id = UUID.randomUUID().toString();
		}

		AnchorState newFeature = new AnchorState(map, id);
		if (map.hasFutureID(id)) {
			newFeature = (AnchorState) map.getFutureFeature(id);
	...
	public static State createAnchorState(IndoorGMLMap map, String parentId, String id, String geometry,
	...
	public static void deleteAnchorState(IndoorGMLMap map, String id) {
		State target = (State) map.getFeature(id);

		if (target == null) {
			if (map.hasFutureID(id))
				target = (AnchorState) map.getFutureFeature(id);
		}
	...
	public static State updateAnchorState(IndoorGMLMap map, String parentId, String id, String name, String description,
		...
		map.removeFeature(id);
		map.setFeature(id, "AnchorState", result);
