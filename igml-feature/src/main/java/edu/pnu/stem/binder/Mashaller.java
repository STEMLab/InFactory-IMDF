...
//	}
	public static void marshalDocument(String path, IndoorGMLMap map) throws JAXBException, IOException {
		ConcurrentHashMap<String, Object> indoorfeaturesforIMDF = map.getFeatureContainer("IndoorFeaturesForIMDF");
		String indoorfeaturesforIMDFId = null;
		for (ConcurrentHashMap.Entry<String, Object> entry : indoorfeaturesforIMDF.entrySet()) {
			indoorfeaturesforIMDFId = entry.getKey();
		}
		marshalIndoorFeaturesForIMDF(path,
				Convert2JaxbClass.change2JaxbClass(map, (IndoorFeaturesForIMDF) map.getFeature(indoorfeaturesforIMDFId)));
	}
...
//	}
	...
	public static void marshalIndoorFeaturesForIMDF(String path, IndoorFeaturesForIMDFType indoorFeaturesType)
			throws JAXBException, IOException {

		JAXBContext context;
		Marshaller marshaller;

		context = JAXBContext.newInstance("net.opengis.indoorgml.core.v_1_0" + ":net.opengis.indoorgml.navigation.v_1_0"  +":net.opengis.indoorgml.imdf.indoorgmlimdf.v_1_0"+ ":net.opengis.gml.v_3_2_1");
		...
		marshaller.setProperty(Marshaller.JAXB_SCHEMA_LOCATION,
				"http://www.opengis.net/indoorgml/1.0/core http://schemas.opengis.net/indoorgml/1.0/indoorgmlcore.xsd "
						+ "http://www.opengis.net/indoorgml/1.0/navigation http://schemas.opengis.net/indoorgml/1.0/indoorgmlnavi.xsd"
						+ "https://0vollov0.github.io/imdfToIndoorGML_XSD https://0vollov0.github.io/imdfToIndoorGML_XSD/indoorgmlimdf.xsd");
		try {
			marshaller.setProperty("com.sun.xml.bind.namespacePrefixMapper", new IndoorGMLNameSpaceMapper());
		} catch (PropertyException e) {
			e.printStackTrace();
	...
	public static class IndoorGMLNameSpaceMapper extends NamespacePrefixMapper {
		...
		private static final String IMDF_PREFIX = "imdf";
		private static final String IMDF_URI = "https://0vollov0.github.io/imdfToIndoorGML_XSD";
		...
		public String getPreferredPrefix(String namespaceUri, String suggestion, boolean requirePrefix) {
			...
			} else if (IMDF_URI.equals(namespaceUri)) {
				return IMDF_PREFIX;
		...
		public String[] getPreDeclaredNamespaceUris() {
			...
			return new String[] { DEFAULT_URI, NAVIGATION_URI, GML_URI, XLINK_URI, IMDF_URI };
		}
	}
