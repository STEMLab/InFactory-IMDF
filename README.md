...
This project is for creating & editing OGC IndoorGML 1.1.0 formated data. This is based on ogc-schemas https://github.com/highsource/ogc-schemas, so later I will add License about this. 
